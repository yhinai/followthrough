...
| P5-01 | Every enabled connector passes auth/policy/failure tests | 5 | pass | 40 effector tests plus current post-reset private task, Google Calendar, owner Discord, and sandbox purchase receipts in `docs/evidence/phase-05-current-state-2026-07-11.md`; GitHub/deploy/live purchase remain bounded by policy |
