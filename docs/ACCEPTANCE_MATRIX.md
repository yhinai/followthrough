...
| P5-01 | Every enabled connector passes auth/policy/failure tests | 5 | pass | 40 effector tests; live private task, Google Calendar, Discord, and sandbox purchase; GitHub/deploy/live purchase remain approval-gated |
| P5-02 | External actions have idempotent receipts | 5 | pass | Effect journal/transition tests and live private task effect `43c1f426-c6d2-46cd-bc19-c6c22498e771` |
...
| P7-01 | Phone-to-action end-to-end succeeds | 7 | pending | Physical Flip delivered 40 encrypted events including screen-off capture; realtime hooks are blocked by current Omi on-device behavior, so a single natural phone utterance through action remains unclaimed |
